...
author: Saki酱的通信学习之路
cover: '"image":"img/lisa_cover1.png"'
cover_image: "[[lisa_cover1.png]]"
catalog: true
share: true
path: 2026-06-14-记一次fft模块重构一基础仿真篇.md
tags:
  - Saki酱的电赛备赛记录
  - DSP
  - FFT
...
zhihu-topics:
  - "#快速傅里叶变换FFT"
zhihu-link: https://zhuanlan.zhihu.com/p/2049330501907919105
zhihu-created-at: 2026-06-14 03:26
---
...
![rect-freqbias-amp.png](staticimgrect-freqbias-amp.png)
...
![516](flattop-freqbias-vs-amp.png)<center> 图2 flattop的频偏-幅偏曲线 </center>
...
![rect-freq-interval-aligned.png](staticimgrect-freq-interval-aligned.png)
...
![hann-freq-interval-unaligned.png](hann-freq-interval-unaligned.png)
...
1. 扫频测试结果
![par_freqbias-freqmse.png](staticimgparfreqbias-freqmse.png)
<center> 图5 频偏-频率估计rmse图像 </center>

如图5所示,频偏为0是rmse约在5Hz左右。rmse在$\delta = 0.3$ 时最大,约在60Hz左右。
![par_freqbias_ampmse.png](staticimgparfreqbiasampmse.png)
...
2. SNR测试结果
![par-freqbias_snr_freq_rmse 1.png](staticimgpar-freqbiassnrfreqrmse-1.png)
<center> 图7 SNR-频率估计rmse图像</center>

频率rmse普遍维持在50-60Hz左右,且可以看到随着snr的升高频率rmse逐渐稳定在52Hz左右。因此,在实践中,最好保持SNR ≥ 10dB。

![par_freqbias-snr-amprmse.png](staticimgparfreqbias-snr-amprmse.png)
...
![square-5dB-nomearge.png](staticimgsquare-5db-nomearge.png)
