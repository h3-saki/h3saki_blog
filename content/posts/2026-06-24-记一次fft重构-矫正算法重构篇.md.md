...
### 3.1.0 抛物线插值算法
#### 3.1.0.1 频偏-频率rmse
![rect-parabolic-freqsweep-freqrmse.png](../../static/img/rect-parabolic-freqsweep-freqrmse.png)
矩形窗下,抛物线插值法造成的频率估计偏差较高。

#### 3.1.0.2 频偏-幅度rmse
![rect-para-freqsw-amprmse.png](../../static/img/rect-para-freqsw-amprmse.png)

#### 3.1.0.3 频偏-相位rmse
![rect-para-freqsw-phasermse.png](../../static/img/rect-para-freqsw-phasermse.png)

#### 3.1.0.4 SNR-频率rmse
![rect-para-snr-freq.png](../../static/img/rect-para-snr-freq.png)

#### 3.1.0.5 SNR-幅度rmse
![rect-para-snr-freq 1.png](../../static/img/rect-para-snr-freq%201.png)

#### 3.1.0.6 频偏-相位rmse
![rect-para-snr-phase.png](../../static/img/rect-para-snr-phase.png)

综合上面的图像可以看出,矩形窗在抛物线插值算法下的频率,幅度,相位估计均表现不佳。抛物线插值算法并不适用与矩形窗。

### 3.1.1 Rife算法
#### 3.1.1.1 频偏-频率rmse
![rect-rife-freq-freq.png](../../static/img/rect-rife-freq-freq.png)

#### 3.1.1.2 频偏-幅值rmse
![rect-rife-freq-amp.png](../../static/img/rect-rife-freq-amp.png)

#### 3.1.1.3 频偏-相位rmse
![rect-rife-freq-phase.png](../../static/img/rect-rife-freq-phase.png)

#### 3.1.1.4 SNR-频率rmse
![rect-rife-snr-freq.png](../../static/img/rect-rife-snr-freq.png)

#### 3.1.1.5 SNR-幅度rmse
![rect-rife-snr-amp.png](../../static/img/rect-rife-snr-amp.png)

#### 3.1.1.6 SNR-相位RMSE
![rect-rife-snr-phase.png](../../static/img/rect-rife-snr-phase.png)
...
#### 3.1.2.1 频偏-频率rmse
![rect-candan-freq-freq.png](../../static/img/rect-candan-freq-freq.png)

#### 3.1.2.1 频偏-幅度rmse
![rect-candan-freq-amp.png](../../static/img/rect-candan-freq-amp.png)

#### 3.1.2.3 频偏-相位rmse
![rect-candan-freq-phase.png](../../static/img/rect-candan-freq-phase.png)

#### 3.1.2.4 SNR-频率rmse
![rect-candan-snr-freq.png](../../static/img/rect-candan-snr-freq.png)

#### 3.1.2.5 SNR-幅度rmse
![rect-candan-snr-amp.png](../../static/img/rect-candan-snr-amp.png)

#### 3.1.2.6 SNR-相位rmse
![rect-candan-snr-phase.png](../../static/img/rect-candan-snr-phase.png)
cadan算法使用复数谱进行频率估计和幅度估计,可以看出估计精度相比于一般的抛物线插值算法已经极大的提高。相位水平也可堪一用。整体水平与hann窗的抛物线插值算法水平相当,甚至在频率估计和相位估计方面略强于hann窗。
## 3.2 hann窗测试
### 3.2.0 抛物线插值算法
#### 3.2.0.1 频偏-频率rmse
![hann-para-freq-freq.png](../../static/img/hann-para-freq-freq.png)

#### 3.2.0.2 频偏-幅度rmse

![hann-para-freq-amp.png](../../static/img/hann-para-freq-amp.png)

#### 3.2.0.3 频偏-相位rmse
![hann-para-freq-phase.png](../../static/img/hann-para-freq-phase.png)

#### 3.2.0.4 SNR-频率rmse

![hann-para-snr-freq 1.png](../../static/img/hann-para-snr-freq%201.png)

#### 3.2.0.5 SNR-幅度rmse

![hann-para-snr-amp.png](../../static/img/hann-para-snr-amp.png)

#### 3.2.0.6 SNR-相位rmse
![hann-para-snr-phase.png](../../static/img/hann-para-snr-phase.png)

### 3.2.1 granke算法
#### 3.2.1.1 频差-频率rmse
![hann-off-freq-freq.png](../../static/img/hann-off-freq-freq.png)

#### 3.2.1.2 频差-幅值rmse
![hann-off-freq-amp 1.png](../../static/img/hann-off-freq-amp%201.png)

#### 3.2.1.3 频差-相位rmse
![hann-off-freq-phase.png](../../static/img/hann-off-freq-phase.png)

#### 3.2.1.4 SNR-频率rmse
![hann-snr-freq.png](../../static/img/hann-snr-freq.png)

#### 3.2.1.5 SNR-幅度rmse
![hann-off-snr-amp.png](../../static/img/hann-off-snr-amp.png)

#### 3.2.1.6 SNR-相位rmse
![hann-off-snr-phase 1.png](../../static/img/hann-off-snr-phase%201.png)
...
![hamming-para-freq-freq.png](../../static/img/hamming-para-freq-freq.png)

#### 3.3.0.2 频偏-幅度rmse

![hamming-para-freq-amp.png](../../static/img/hamming-para-freq-amp.png)

#### 3.3.0.3 频偏-相位rmse

![hamming-para-freq-phase.png](../../static/img/hamming-para-freq-phase.png)

#### 3.3.0.4 SNR-频率rmse

![hamming-para-snr-freq.png](../../static/img/hamming-para-snr-freq.png)

#### 3.3.0.5 SNR-幅度rmse

![hamming-para-snr-amp.png](../../static/img/hamming-para-snr-amp.png)

#### 3.3.0.6 SNR-相位rmse

![hamming-para-snr-phase.png](../../static/img/hamming-para-snr-phase.png)
不如hann窗
### 3.3.1 offelli算法
#### 3.3.1.1 频偏-频率rmse
![hamming-off-freq-freq.png](../../static/img/hamming-off-freq-freq.png)

#### 3.3.1.2 频偏-幅度rmse
![hamming-off-freq-amp.png](../../static/img/hamming-off-freq-amp.png)

#### 3.3.1.3 频偏-相位rmse
![hamming-off-freq-phase.png](../../static/img/hamming-off-freq-phase.png)

#### 3.3.1.4 SNR-频率rmse

![hamming-off-snr-freq 1.png](../../static/img/hamming-off-snr-freq%201.png)

#### 3.3.1.5 SNR-幅度rmse

![hamming-off-snr-amp 2.png](../../static/img/hamming-off-snr-amp%202.png)

#### 3.3.1.5 snr-相位rmse

![hamming-off-snr-phase.png](../../static/img/hamming-off-snr-phase.png)
...
![blackman-para-freq-freq.png](../../static/img/blackman-para-freq-freq.png)

#### 3.4.1.2 频偏-幅值rmse

![blackman-para-freq-amp.png](../../static/img/blackman-para-freq-amp.png)

#### 3.4.1.3 频偏-相位rmse

![blackman-para-freq-phase.png](../../static/img/blackman-para-freq-phase.png)

#### 3.4.1.4 SNR-频率rmse

![blackman-para-snr-freq.png](../../static/img/blackman-para-snr-freq.png)

#### 3.4.1.5 SNR-幅值rmse

![blackman-para-snr-amp.png](../../static/img/blackman-para-snr-amp.png)

#### 3.4.1.6 SNR-相位rmse

![blackman-para-snr-phase.png](../../static/img/blackman-para-snr-phase.png)

### 3.4.2 adria算法
#### 3.4.2.1 频偏-频率rmse

![blackman-adr-freq-freq.png](../../static/img/blackman-adr-freq-freq.png)

#### 3.4.2.2 频偏-幅值rmse

![blackman-adr-freq-amp.png](../../static/img/blackman-adr-freq-amp.png)

#### 3.4.2.3 频偏-相位rmse

![blackman-adr-freq-phase.png](../../static/img/blackman-adr-freq-phase.png)

#### 3.4.2.4 SNR-频率rmse

![blackman-adr-snr-freq.png](../../static/img/blackman-adr-snr-freq.png)

#### 3.4.2.5 SNR-幅度rmse

![484](../../static/img/blackman-adr-snr-amp.png)

#### 3.4.2.6 SNR-相位rmse

![blackman-adr-snr-phase.png](../../static/img/blackman-adr-snr-phase.png)
...
![blackmanharris-para-freq-freq.png](../../static/img/blackmanharris-para-freq-freq.png)

#### 3.5.1.2 频偏-幅度rmse

![blackmanharris-para-frerq-amp.png](../../static/img/blackmanharris-para-frerq-amp.png)

#### 3.5.1.3 频偏-相位rmse

![blackmanharris-para-freq-phase.png](../../static/img/blackmanharris-para-freq-phase.png)

#### 3.5.1.4 SNR-频率rmse

![blackmanharris-para-snr-freq.png](../../static/img/blackmanharris-para-snr-freq.png)

#### 3.5.1.5 SNR-幅度rmse

![blackmanharris-para-snr-amp.png](../../static/img/blackmanharris-para-snr-amp.png)

#### 3.5.1.6 SNR-相位rmse

![blackmanharris-para-snr-phase.png](../../static/img/blackmanharris-para-snr-phase.png)

### 3.5.2 agrez算法

#### 3.5.2.1 频偏-频率rmse

![blackmanharris-agr-freq-freq.png](../../static/img/blackmanharris-agr-freq-freq.png)

#### 3.5.2.2 频偏-幅值rmse

![blackmanharris-agr-freq-amp 2.png](../../static/img/blackmanharris-agr-freq-amp%202.png)

#### 3.5.2.3 频偏-相位rmse

![blackmanharris-agr-freq-phase.png](../../static/img/blackmanharris-agr-freq-phase.png)

#### 3.5.2.4 SNR-幅度rmse

![blackmanharris-agr-snr-amp.png](../../static/img/blackmanharris-agr-snr-amp.png)

#### 3.5.2.5 SNR-相位rmse

![blackmanharris-agr-snr-phase.png](../../static/img/blackmanharris-agr-snr-phase.png)
...
![flattop_para_freq_freq.png](../../static/img/flattop_para_freq_freq.png)

#### 3.6.1.2 频偏-幅值rmse

![flattop_para_freq_amp.png](../../static/img/flattop_para_freq_amp.png)

#### 3.6.1.3 频偏-相位rmse

![flattop_para_freq_amp 1.png](../../static/img/flattop_para_freq_amp%201.png)

#### 3.6.1.4 SNR-频率rmse

![flattop_and_snr_freq.png](../../static/img/flattop_and_snr_freq.png)

#### 3.6.1.5 SNR-幅度rmse

![flattop_para_snr_amp.png](../../static/img/flattop_para_snr_amp.png)

#### 3.6.1.6 SNR-相位rmse

![flattop_para_snr_phase.png](../../static/img/flattop_para_snr_phase.png)

### 3.6.2 andria算法
#### 3.6.2.1 频偏-频率rmse
![flattop_and_freq_freq.png](../../static/img/flattop_and_freq_freq.png)


#### 3.6.2.2 频偏-幅值rmse

![flattop_and_freq_amp.png](../../static/img/flattop_and_freq_amp.png)

#### 3.6.2.3 频偏-相位rmse

![flattop_and_freq_phase.png](../../static/img/flattop_and_freq_phase.png)

#### 3.6.2.4 SNR-频率rmse

![flattop_and_snr_freq 1.png](../../static/img/flattop_and_snr_freq%201.png)

#### 3.6.2.5 SNR-幅度rmse

![flattop_and_snr_amp.png](../../static/img/flattop_and_snr_amp.png)

#### 3.6.2.6 SNR-相位rmse

![flattop_and_snr_phase.png](../../static/img/flattop_and_snr_phase.png)
