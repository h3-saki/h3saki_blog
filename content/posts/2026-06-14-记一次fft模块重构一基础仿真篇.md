...
![[rect-freqbias-amp.png|rect-freqbias-amp.png]]
...
![[flattop-freqbias-vs-amp.png|516]]<center> 图2 flattop的频偏-幅偏曲线 </center>
...
![[rect-freq-interval-aligned.png|rect-freq-interval-aligned.png]]
...
1. 扫频测试结果
![[par_freqbias-freqmse.png|par_freqbias-freqmse.png]]
<center> 图5 频偏-频率估计rmse图像 </center>

如图5所示,频偏为0是rmse约在5Hz左右。rmse在$\delta = 0.3$ 时最大,约在60Hz左右。
![[par_freqbias_ampmse.png|par_freqbias_ampmse.png]]
...
2. SNR测试结果
![[par-freqbias_snr_freq_rmse 1.png|par-freqbias_snr_freq_rmse 1.png]]
<center> 图7 SNR-频率估计rmse图像</center>

频率rmse普遍维持在50-60Hz左右,且可以看到随着snr的升高频率rmse逐渐稳定在52Hz左右。因此,在实践中,最好保持SNR ≥ 10dB。

![[par_freqbias-snr-amprmse.png|par_freqbias-snr-amprmse.png]]
...
![[square-5dB-nomearge.png|square-5dB-nomearge.png]]
