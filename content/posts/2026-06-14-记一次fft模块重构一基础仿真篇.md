...
> 注:为了尽量减少fft的栅栏效应所产生的影响,我们在测量幅值时,往往采取过采样(oversample)的方法。即通过末尾补0(可以提升频率分辨力)的方法,来减少这个影响。习惯中,一般是补齐到原数组长度的64倍或128倍
...
![rect-freqbias-amp.png](/img/rect-freqbias-amp.png)
...
![flattop-freqbias-vs-amp.png](/img/flattop-freqbias-vs-amp.png)
...
![rect-freq-interval-aligned.png](/img/rect-freq-interval-aligned.png)
...
![hann-freq-interval-unaligned.png](/img/hann-freq-interval-unaligned.png)
...
![par_freqbias-freqmse.png](/img/par_freqbias-freqmse.png)
<center> 图5 频偏-频率估计rmse图像 </center>

如图5所示,频偏为0是rmse约在5Hz左右。rmse在$\delta = 0.3$ 时最大,约在60Hz左右。

![par_freqbias_ampmse.png](/img/par_freqbias_ampmse.png)
...
2. SNR测试结果
![par-freqbias_snr_freq_rmse 1.png](/img/par-freqbias_snr_freq_rmse%201.png)
<center> 图7 SNR-频率估计rmse图像</center>

频率rmse普遍维持在50-60Hz左右,且可以看到随着snr的升高频率rmse逐渐稳定在52Hz左右。因此,在实践中,最好保持SNR ≥ 10dB。

![par_freqbias-snr-amprmse.png](/img/par_freqbias-snr-amprmse.png)
...
![square-5dB-nomearge.png](/img/square-5dB-nomearge.png)
...
![tri-10dB.png](/img/tri-10dB.png)
<center> 图9 SNR=10dB时三角波筛选后的频谱(线性谱) </center>

![tri-20dB.png](/img/tri-20dB.png)
<center> 图10 SNR=20dB时三角波筛选后的频谱(线性谱) </center>

![tri-30db.png](/img/tri-30db.png)
